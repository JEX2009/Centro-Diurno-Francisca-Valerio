...
import useTerapia from "./hooks/useTerapias"
import { useState } from "react";

export default function TerapiasPage() {
    const { terapias, isLoadingTerapia, errorTerapia, crearTerapia, isLoading,succes} = useTerapia();
    const [nombreTerapia, setTerapia] = useState('');
    if (isLoadingTerapia) {
        return <LoadingSpinner />
    }
    if (errorTerapia) {
        return <ErrorMessage message={errorTerapia} />
    }

    const handleCreate = () => {
        if (!nombreTerapia.trim()) return;
        crearTerapia({ nombre: nombreTerapia });
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1 bg-gray-50 p-4 rounded-xl shadow-md h-fit">
                    <h2 className="text-xl font-bold text-gray-700 mb-3">Crear Nueva Terapia</h2>
                ...
                <div className="md:col-span-2">
                    <h2 className="text-xl font-bold text-gray-700 mb-3 border-b pb-1">Terapias Existentes ({terapias.length})</h2>
